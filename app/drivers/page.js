...
export default function DriversPage() {
  ...
  const [form, setForm] = useState({ name: '', phone: '', truckId: '' })
                  ...
                  {drivers.map((driver) => (
                    <tr key={driver.id} className="border-b border-gray-800 hover:bg-gray-800/50">
                      ...
                      <td className="p-4 text-gray-400">
                        {new Date(driver.created_at).toLocaleDateString('en-KE', { timeZone: 'Africa/Nairobi' })}
                      </td>
                      <td className="p-4">
                        <button
